...
object AndroidTestDependencies{
    ...
    val espresso_intent = "androidx.test.espresso:espresso-intents:${Versions.espresso_core}"
    val dagger_hilt_test = "com.google.dagger:hilt-android-testing:${Versions.dagger_hilt}"
